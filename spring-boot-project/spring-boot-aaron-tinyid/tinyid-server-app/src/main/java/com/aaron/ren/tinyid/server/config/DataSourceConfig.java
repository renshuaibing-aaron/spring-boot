package com.aaron.ren.tinyid.server.config;
...
public class DataSourceConfig {
    ...
    private static final String DEFAULT_DATASOURCE_TYPE = "org.apache.tomcat.    @Autowired\n" +
            "    private Environment environment;\njdbc.pool.DataSource";

    @Bean
    public DataSource getDynamicDataSource(Environment environment) {
