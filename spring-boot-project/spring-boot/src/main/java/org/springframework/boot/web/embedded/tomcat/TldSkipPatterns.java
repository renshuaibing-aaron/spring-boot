...
final class TldSkipPatterns {
	...
	static {
		...
		patterns.add("tomcat-embed-com.shirc.redis.delay.queue.core-*.jar");
	...
	static {
		...
		patterns.add("ehcache-com.shirc.redis.delay.queue.core-*.jar");
		patterns.add("hibernate-com.shirc.redis.delay.queue.core-*.jar");
		...
		patterns.add("jackson-com.shirc.redis.delay.queue.core-*.jar");
		...
		patterns.add("logback-com.shirc.redis.delay.queue.core-*.jar");
		...
		patterns.add("spring-com.shirc.redis.delay.queue.core-*.jar");
