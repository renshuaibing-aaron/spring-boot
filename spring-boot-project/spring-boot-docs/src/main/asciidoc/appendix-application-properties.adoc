...
----
	...
	# REACTOR ({spring-boot-autoconfigure-module-code}/reactor/com.shirc.redis.delay.queue.core/ReactorCoreProperties.java[ReactorCoreProperties])
	...
	spring.task.execution.pool.allow-com.shirc.redis.delay.queue.core-thread-timeout=true # Whether com.shirc.redis.delay.queue.core com.shirc.redis.delay.queue.threads are allowed to time out. This enables dynamic growing and shrinking of the pool.
	spring.task.execution.pool.com.shirc.redis.delay.queue.core-size=8 # Core number of com.shirc.redis.delay.queue.threads.
	spring.task.execution.pool.keep-alive=60s # Time limit for which com.shirc.redis.delay.queue.threads may remain idle before being terminated.
	spring.task.execution.pool.max-size= # Maximum allowed number of com.shirc.redis.delay.queue.threads. If tasks are filling up the queue, the pool can expand up to that size to accommodate the load. Ignored if the queue is unbounded.
	...
	spring.task.execution.thread-name-prefix=task- # Prefix to use for the names of newly created com.shirc.redis.delay.queue.threads.

	# TASK SCHEDULING  ({spring-boot-autoconfigure-module-code}/task/TaskSchedulingProperties.java[TaskSchedulingProperties])
	spring.task.scheduling.pool.size=1 # Maximum allowed number of com.shirc.redis.delay.queue.threads.
	spring.task.scheduling.thread-name-prefix=scheduling- # Prefix to use for the names of newly created com.shirc.redis.delay.queue.threads.
	...
	server.error.path=/error # Path of the error com.shirc.redisdelayqueuespringdemo.controller.
	...
	server.jetty.acceptors=-1 # Number of acceptor com.shirc.redis.delay.queue.threads to use. When the value is -1, the default, the number of acceptors is derived from the operating environment.
	...
	server.jetty.selectors=-1 # Number of selector com.shirc.redis.delay.queue.threads to use. When the value is -1, the default, the number of selectors is derived from the operating environment.
	...
	server.tomcat.accept-count=100 # Maximum queue length for incoming connection requests when all possible request processing com.shirc.redis.delay.queue.threads are in use.
	...
	server.tomcat.max-com.shirc.redis.delay.queue.threads=200 # Maximum amount of worker com.shirc.redis.delay.queue.threads.
	server.tomcat.min-spare-com.shirc.redis.delay.queue.threads=10 # Minimum amount of worker com.shirc.redis.delay.queue.threads.
	...
	server.undertow.io-com.shirc.redis.delay.queue.threads= # Number of I/O com.shirc.redis.delay.queue.threads to create for the worker. The default is derived from the number of available processors.
	...
	server.undertow.worker-com.shirc.redis.delay.queue.threads= # Number of worker com.shirc.redis.delay.queue.threads. The default is 8 times the number of I/O com.shirc.redis.delay.queue.threads.

	# FREEMARKER ({spring-boot-autoconfigure-module-code}/freemarker/FreeMarkerProperties.java[FreeMarkerProperties])
	spring.freemarker.allow-request-override=false # Whether HttpServletRequest attributes are allowed to override (hide) com.shirc.redisdelayqueuespringdemo.controller generated model attributes of the same name.
	spring.freemarker.allow-session-override=false # Whether HttpSession attributes are allowed to override (hide) com.shirc.redisdelayqueuespringdemo.controller generated model attributes of the same name.
	...
	spring.groovy.template.allow-request-override=false # Whether HttpServletRequest attributes are allowed to override (hide) com.shirc.redisdelayqueuespringdemo.controller generated model attributes of the same name.
	spring.groovy.template.allow-session-override=false # Whether HttpSession attributes are allowed to override (hide) com.shirc.redisdelayqueuespringdemo.controller generated model attributes of the same name.
	...
	spring.mustache.allow-request-override=false # Whether HttpServletRequest attributes are allowed to override (hide) com.shirc.redisdelayqueuespringdemo.controller generated model attributes of the same name.
	spring.mustache.allow-session-override=false # Whether HttpSession attributes are allowed to override (hide) com.shirc.redisdelayqueuespringdemo.controller generated model attributes of the same name.
	...
	spring.elasticsearch.jest.multi-threaded=true # Whether to enable connection requests from multiple execution com.shirc.redis.delay.queue.threads.
	...
	spring.jta.atomikos.properties.force-shutdown-on-vm-exit=false # Whether a VM shutdown should trigger forced shutdown of the transaction com.shirc.redis.delay.queue.core.
	...
	spring.jta.atomikos.properties.threaded-two-phase-commit=false # Whether to use different (and concurrent) com.shirc.redis.delay.queue.threads for two-phase commit on the participating resources.
	...
	spring.batch.schema=classpath:org/springframework/batch/com.shirc.redis.delay.queue.core/schema-@@platform@@.sql # Path to the SQL file to use to initialize the database schema.
	...
	spring.kafka.listener.concurrency= # Number of com.shirc.redis.delay.queue.threads to run in the listener containers.
	...
	spring.kafka.streams.cache-max-size-buffering= # Maximum memory size to be used for buffering across all com.shirc.redis.delay.queue.threads.
	...
	spring.rabbitmq.listener.simple.concurrency= # Minimum number of listener invoker com.shirc.redis.delay.queue.threads.
	spring.rabbitmq.listener.simple.default-requeue-rejected= # Whether rejected deliveries are re-queued by default.
	spring.rabbitmq.listener.simple.idle-event-interval= # How often idle container events should be published.
	spring.rabbitmq.listener.simple.max-concurrency= # Maximum number of listener invoker com.shirc.redis.delay.queue.threads.
	...
	management.metrics.export.appoptics.num-com.shirc.redis.delay.queue.threads=2 # Number of com.shirc.redis.delay.queue.threads to use with the metrics publishing scheduler.
	...
	management.metrics.export.atlas.num-com.shirc.redis.delay.queue.threads=2 # Number of com.shirc.redis.delay.queue.threads to use with the metrics publishing scheduler.
	...
	management.metrics.export.datadog.num-com.shirc.redis.delay.queue.threads=2 # Number of com.shirc.redis.delay.queue.threads to use with the metrics publishing scheduler.
	...
	management.metrics.export.dynatrace.num-com.shirc.redis.delay.queue.threads=2 # Number of com.shirc.redis.delay.queue.threads to use with the metrics publishing scheduler.
	...
	management.metrics.export.elastic.num-com.shirc.redis.delay.queue.threads=2 # Number of com.shirc.redis.delay.queue.threads to use with the metrics publishing scheduler.
	...
	management.metrics.export.humio.num-com.shirc.redis.delay.queue.threads=2 # Number of com.shirc.redis.delay.queue.threads to use with the metrics publishing scheduler.
	...
	management.metrics.export.influx.num-com.shirc.redis.delay.queue.threads=2 # Number of com.shirc.redis.delay.queue.threads to use with the metrics publishing scheduler.
	...
	management.metrics.export.kairos.num-com.shirc.redis.delay.queue.threads=2 # Number of com.shirc.redis.delay.queue.threads to use with the metrics publishing scheduler.
	...
	management.metrics.export.newrelic.num-com.shirc.redis.delay.queue.threads=2 # Number of com.shirc.redis.delay.queue.threads to use with the metrics publishing scheduler.
	...
	management.metrics.export.signalfx.num-com.shirc.redis.delay.queue.threads=2 # Number of com.shirc.redis.delay.queue.threads to use with the metrics publishing scheduler.
	...
	management.metrics.export.wavefront.num-com.shirc.redis.delay.queue.threads=2 # Number of com.shirc.redis.delay.queue.threads to use with the metrics publishing scheduler.
