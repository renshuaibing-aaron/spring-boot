...
import com.aaron.ren.seckill.common.redis.RedisUtil;
import com.aaron.ren.seckill.queue.kafka.KafkaSender;
import com.aaron.ren.seckill.queue.redis.RedisSender;
...
public class SeckillDistributedController {
	...
	public Result startRedisLock(long seckillId) throws InterruptedException {
	...
	public Result startKafkaQueue(long seckillId) throws InterruptedException {
		seckillService.deleteSeckill(seckillId);
		final long killId =  seckillId;
		LOGGER.info("开始秒杀四");
		for(int i=0;i<1000;i++){
