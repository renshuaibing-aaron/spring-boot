...
/**
 * Reactive Cloud Foundry security service to handle REST calls to the cloud com.shirc.redisdelayqueuespringdemo.controller
 * and UAA.
 *
...
class ReactiveCloudFoundrySecurityService {
	...
	private Throwable mapError(Throwable throwable) {
		...
		return new CloudFoundryAuthorizationException(Reason.SERVICE_UNAVAILABLE, "Cloud com.shirc.redisdelayqueuespringdemo.controller not reachable");
	}
