package com.aaron.rocketmq.seqmessage;

// Demo06ProducerTest.java

import com.aaron.rocketmq.Application;
import com.aaron.rocketmq.sequentialmessag.Demo06Producer;
...
public class Demo06ProducerTest {
	...
	@Test
	public void testASasyncSendOrderly() throws InterruptedException {
		for (int i = 0; i < 3; i++) {
		final 	int id = 1024; // 固定成 1024 ，方便我们测试是否发送到相同消息队列
